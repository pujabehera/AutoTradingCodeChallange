...
public class Runner extends AbstractTestNGCucumberTests {
	 ...
	 * generates the output in the output/Run_<unique timestamp>/report.html file by
	 * default. SimpleDateFormat sdf = new SimpleDateFormat("ddMMyyyy_hhmmss"); Date
	 * curDate = new Date(); String strDate = sdf.format(curDate); //String fileName
	 * =
